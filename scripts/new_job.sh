...
cp jobs/_template/outputs/job_analysis.md "$target_dir/outputs/job_analysis.md"
cp jobs/_template/outputs/resume_changes.md "$target_dir/outputs/resume_changes.md"
cp jobs/_template/outputs/cover_letter.md "$target_dir/outputs/cover_letter.md"
cp jobs/_template/outputs/hr_video_script.md "$target_dir/outputs/hr_video_script.md"
