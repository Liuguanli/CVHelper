...
Software engineer and postdoctoral researcher with strong experience in data infrastructure, backend systems, benchmarking, and retrieval-oriented workflows. I have built systems for data ingestion, workload parsing, layout recommendation, performance evaluation, and internal retrieval tools, with a focus on reliability, reproducibility, and practical system behavior. My work spans both research and engineering settings, which fits well with infrastructure roles that support research teams at scale.
...
\item \textbf{Data Infrastructure / Retrieval:} Ingestion pipelines, reproducible data workflows, benchmarking, RAG, and retrieval-oriented tooling
