...
Systems PhD and software engineer with six years of research experience and three years of engineering experience building database and backend systems with a focus on performance. My work combines research depth with practical engineering delivery across query processing, physical data design, indexing, benchmarking, and data-intensive system tooling. I have built prototypes and production-oriented workflows for dataset ingestion, SQL workload parsing, layout recommendation, performance evaluation, and backend data pipelines, with publications in venues such as VLDB and ICDE. Across academia and engineering roles, I have focused on turning systems ideas into measurable improvements in performance, reliability, and developer usability.
...
\textit{Lead research and engineering projects on database systems, physical design, indexing, benchmarking, and performance-focused query systems.}
\textit{Build end-to-end prototypes, evaluate system trade-offs, supervise junior researchers, and collaborate with academic and industry partners.}
...
\textit{Worked on Baidu's IM platform serving employees and business partners.}
\begin{itemize}[parsep=0.4ex]
