...
Research-oriented software engineer and postdoctoral researcher with a strong background in systems performance analysis, benchmarking, data systems, and prototype building. My research has focused on understanding performance trade-offs in data-intensive systems through physical design, indexing, workload analysis, and evaluation frameworks, with publications in venues such as VLDB and ICDE. Across research and industry, I have built backend systems, data pipelines, retrieval-oriented tools, and reproducible evaluation workflows. This gives me a strong foundation for systems research roles that value careful measurement, prototyping, and scaling-oriented thinking.
...
\item \textbf{Systems / Performance Research:} Benchmarking, performance modeling, prototype building, retrieval, and systems evaluation
