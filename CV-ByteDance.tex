...
% Redmond is 5808079, San Francisco is 5391959, New York City is 5128581, Seattle is 5809844, Singapore is 1880252, Munich is 2867714, Barcelona is 3128760, Vancouver is 6173331, Tokyo is 1850147, Melbourne is 2158177, and the removed city Beijing is 1816670
...
Software engineer and postdoctoral researcher with a strong background in scalable backend systems, data infrastructure, and performance optimization. I have built and studied large-scale systems for data ingestion, query processing, indexing, and retrieval, with a focus on reliability, scalability, debuggability, and efficient execution. My PhD and postdoctoral work involved designing and implementing high-performance data systems published in top database venues such as VLDB and ICDE. In both research and industry settings, I have delivered end-to-end systems involving backend services, data pipelines, benchmarking frameworks, and query optimization components. Earlier in my career, I worked as a Software Engineer and Data Scientist, gaining practical experience in software development, distributed processing, and production-oriented data workflows.
...
\textit{Lead research and engineering projects on database benchmarking, indexing, and AI-driven query processing.}
\textit{Design system prototypes, supervise junior researchers, and collaborate with academic and industry partners.}
